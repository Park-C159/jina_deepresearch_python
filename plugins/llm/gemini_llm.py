...
@register_plugin("llm", "gemini")
class GeminiLLMPlugin(BaseLLMPlugin):
    """Google Gemini 模型插件"""
    ...
    def initialize(self, cfg: Dict[str, Any]) -> None:
        ...
        genai.configure(api_key=self.api_key, **(self.provider_cfg.get("clientConfig") or {}))
